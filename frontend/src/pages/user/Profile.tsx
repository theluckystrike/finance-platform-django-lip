                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <h6 className="mb-0">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="feather feather-twitter me-2 icon-inline text-green"
                        >
                    ...
                    <li className="list-group-item d-flex justify-content-between align-items-center flex-wrap">
                      <h6 className="mb-0">
                        <svg
                          ...
                          strokeLinecap="round"
                          strokeLinejoin="round"
                          className="feather feather-facebook me-2 icon-inline text-green"
                        >
                ...
                <div className="card-body">
                  ...
                  <div className="row">
                    ...
                    <div className="col-sm-9 text-secondary">
                      <input
                        type="button"
                        className="float-end btn btn-green px-4"
                        value="Save Changes"
                      />
                    </div>
                  </div>
